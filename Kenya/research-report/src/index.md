...
- **25** reef survey sites across 3 programmes
...
const coralCondition = [
  {indicator: "Live coral cover", opening: 0.905, closing: 0.730, change: -0.175},
  {indicator: "Coral bleaching", opening: 0.628, closing: 1.000, change: 0.372},
  {indicator: "Coral health", opening: 0.809, closing: 0.977, change: 0.168},
  {indicator: "Coral recruitment", opening: 0.010, closing: 0.054, change: 0.044},
  {indicator: "Fish biomass", opening: 0.207, closing: 0.380, change: 0.173},
  {indicator: "Fish richness", opening: 0.558, closing: 0.728, change: 0.169},
  {indicator: "Composite", opening: 0.520, closing: 0.645, change: 0.125}
];
```
...
Overall composite condition improved from 0.520 to 0.645 (+0.125), driven by post-bleaching recovery in coral health and bleaching indices. Coral recruitment remains critically low (CI 0.054), the single most concerning indicator.
