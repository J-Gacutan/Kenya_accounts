...
Save Estuary is divided into **7 distinct mangrove forest assets**. Below is analysis for each:
...
#### Asset 7
- **Canopy Height:** 6.26 m | **Biomass:** 20.75 ± 17.14 Mg/ha | **Canopy Cover:** 32.8% | **PAI:** 1.293 m²/m²
- **Carbon Stock:** 9.75 Mg C/ha | **GEDI Footprints:** 6
- **Character:** **Second-highest productivity** — denser, taller forest; moderate GEDI coverage

### 2.3 Key Findings — Save Estuary

1. **High heterogeneity:** Biomass ranges from 9.1 to 27.3 Mg/ha (3-fold variation). Two standout patches (Assets 3 & 7) show mature forest character; remainder are sparse woodlands.

2. **Canopy structure:** Most assets have <10% canopy closure (sparse). Assets 3 & 7 exceed 30% closure, indicating denser, more productive stands.
...
5. **Carbon baseline:** Site-level aggregation = **5.94 Mg C/ha**. Using 2020 GMW extent of 12,085 ha, total Save estuary carbon stock ≈ **71,700 Mg C (71.7 Gg C)** or **~263,000 Mg CO₂ eq**.
...
5. **Carbon baseline:** Site-level aggregation = **5.15 Mg C/ha**. Using 2020 GMW extent of 1,677 ha, total Morrumbene carbon stock ≈ **8,630 Mg C (8.63 Gg C)** or **~31,700 Mg CO₂ eq**.
...
| **GMW 2020 Extent** | 12,085 ha | 1,677 ha | Save: 7.2× larger |
| **Total Carbon Stock (2020)** | ~71,700 Mg C | ~8,630 Mg C | Save: 8.3× more total carbon |
| **Data Quality** | Uneven (1–31 observations/asset) | Homogeneous (15–95 observations/asset) | Morrumbene: more reliable estimates |

**Overall Assessment:** Save estuary is larger, denser, and more carbon-rich in aggregate, but internally heterogeneous (some patches highly productive, others degraded). Morrumbene is smaller, more uniform, and sparser throughout, but better-measured by GEDI.
...
- **Save Estuary:** 12.63 Mg/ha biomass × ~12,085 ha (2020) = baseline carbon stock ~71,700 Mg C
- **Morrumbene:** 10.95 Mg/ha biomass × ~1,677 ha (2020) = baseline carbon stock ~8,630 Mg C
